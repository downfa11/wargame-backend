...
import com.ns.membership.adapter.out.kafka.KafkaTaskProducerAdapter;
...
class KafkaTaskProducerAdapterTest {
    ...
    void Task를_발행하는_메서드() {
        // given
        Task task = createTask("Membership Response", "123",
                List.of(createSubTask("membership", "123", SubTask.TaskType.post, SubTask.TaskStatus.ready, 123L)));
